    ...
    axios
      ...
      .then(function (response) {
        setMessage({
          ...
          body: "Thank you for reaching out to us! Our team will review your message and get back to you shortly.",
          type: "success",
        });
    ...
    <Fragment>
      <main className="overflow-hidden">
          ...
          <div className="py-20 sm:py-20">
            <div className="relative z-10 mx-auto max-w-7xl pl-4 pr-8 sm:px-6 lg:px-8">
              ...
              <p className="mt-6 max-w-3xl text-xl text-warm-gray-500">
                Don't hesitate to reach out to us via the contact information
                provided below - our team is ready to provide the information
                and support you need to make informed decisions about your
                business."
              </p>
            </div>
          </div>
        ...
        <section aria-labelledby="offices-heading">
          <div className="mx-auto max-w-7xl py-2 px-6 sm:py-0 lg:px-8 mt-10">
            <h2
              id="offices-heading"
              className="text-3xl tracking-tight text-warm-gray-900"
            >
              Our offices
            </h2>
            <p className="mt-2 max-w-3xl text-lg font-extralight text-warm-gray-500">
